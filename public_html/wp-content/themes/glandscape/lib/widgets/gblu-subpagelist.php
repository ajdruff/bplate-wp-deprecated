...
/**
 * Register our widget.
 * 'gblu_Subpage_Widget' is the widget class used below.
 *
 * @since 0.1
 */
function subpage_load_widgets() {
	register_widget( 'gblu_Subpage_Widget' );
}
 ...
 * @since 0.1
 */
class gblu_Subpage_Widget extends WP_Widget {

	/**
	 * Widget setup.
	 */
	function gblu_Subpage_Widget() {
		/* Widget settings. */
		...
		/* Create the widget. */
		$this->WP_Widget( 'subpage-widget', __('gblu // SUB PAGE LIST', 'example'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => __('Subpages', 'example'), 'subpagecount' => '5' );
