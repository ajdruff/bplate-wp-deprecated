 ...
 * @since 0.1
 */
add_action( 'widgets_init', 'gblulatestposts_load_widgets' );

/**
 * Register our widget.
 * 'gblu_Latestposts_Widget' is the widget class used below.
 *
 * @since 0.1
 */
function gblulatestposts_load_widgets() {
	register_widget( 'gblu_Latestposts_Widget' );
}
 ...
 * @since 0.1
 */
class gblu_Latestposts_Widget extends WP_Widget {

	/**
	 * Widget setup.
	 */
	function gblu_Latestposts_Widget() {
		/* Widget settings. */
		$gblulatestpostswidget_ops = array( 'classname' => 'example', 'description' => __('Displays a list of recent posts', 'example') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'gblulatestposts-widget' );

		/* Create the widget. */
		$this->WP_Widget( 'gblulatestposts-widget', __('gblu - LATEST POSTS', 'example'), $gblulatestpostswidget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		elseif($myposttype == 'Portfolio'){$setPosttype = 'gbluPortfolio';}
		...
		<?php gblu_post_image('micro','','permalink');?>
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => __('Latest posts', 'example'), 'newscount' => '5', 'myposttype' => 'gbluPortfolio', 'showexcerpt' => 'checked', 'showimage' => 'checked' );
