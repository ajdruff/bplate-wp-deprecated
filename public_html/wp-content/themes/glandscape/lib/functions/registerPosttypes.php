...
// PORTFOLIO
/*
function gblu_post_type_portfolio() {
	register_post_type('gbluportfolio', 
				array(
				'label' => __('Portfolio'),
				'public' => true,
				'show_ui' => true,
				...
				'query_var' => "gbluportfolio", // This goes to the WP_Query schema
				...
				register_taxonomy("gbluportfoliocats", 
				array("gbluportfolio"), 
...
add_action('init', 'gblu_post_type_portfolio');
*/

// SLIDESHOW POST TYPE

function gblu_post_type_slide() {
	register_post_type('slide', 
				...
				'query_var' => "gbluslide", // This goes to the WP_Query schema
...
add_action('init', 'gblu_post_type_slide');


/*

// TESTIMONIAL POST TYPE
function gblu_post_type_testimonial() {
...
add_action('init', 'gblu_post_type_testimonial');
*/

// NEWS POST TYPE

/*
function gblu_post_type_news() {
...
add_action('init', 'gblu_post_type_news');

*/

// FAQ POST TYPE 
/*
function gblu_post_type_faq() {
...
add_action('init', 'gblu_post_type_faq');

*/

// EVENTS POST TYPE
/*
function gblu_post_type_events() {
...
add_action('init', 'gblu_post_type_events');
*/
