...
define('gblu_SCRIPTS_FOLDER', get_template_directory_uri() . '/lib/scripts');

function gbluness_image_resize($width,$height,$img_url) {
	global $blog_id;
	...
	//If WP MU
		if ( (defined('WP_ALLOW_MULTISITE')) && (WP_ALLOW_MULTISITE == true) ) {
			...
			$img_url = gblu_SCRIPTS_FOLDER."/timthumb.php?src=$the_image_src&amp;w=$width&amp;h=$height&amp;zc=1&amp;q=$imageQuality";
		}else{
			$img_url = gblu_SCRIPTS_FOLDER."/timthumb.php?src=$img_url&amp;w=$width&amp;h=$height&amp;zc=1&amp;q=$imageQuality";	
		}
	}
	return $img_url;
}
...
function pager_init() {
	...
	$pager_options['first_text'] = '&laquo; First';
	$pager_options['last_text'] = 'Last &raquo';
	$pager_options['next_text'] = '<li>&raquo;</li>';
	$pager_options['prev_text'] = '<li>&laquo;</li>';
	$pager_options['dotright_text'] = '...';
	$pager_options['dotleft_text'] = '...';
