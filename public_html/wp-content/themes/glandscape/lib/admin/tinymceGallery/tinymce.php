<?php
class add_gblu_gallery {
	
	var $pluginname = 'gblu_gallery';
	var $path = '';
	var $internalVersion = 100;
	
	function add_gblu_gallery()  {
		
		// Set path to editor_plugin.js
		$this->path = get_template_directory_uri() . '/lib/admin/tinymceGallery/';	
...
$tinymce_button = new add_gblu_gallery ();
