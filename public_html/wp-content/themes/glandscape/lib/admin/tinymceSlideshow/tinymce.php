<?php
class add_gblu_slideshow {
	
	var $pluginname = 'gblu_slideshow';
	var $path = '';
	var $internalVersion = 100;
	
	function add_gblu_slideshow()  {
		
		// Set path to editor_plugin.js
		$this->path = get_template_directory_uri() . '/lib/admin/tinymceSlideshow/';	
...
$tinymce_button = new add_gblu_slideshow ();
