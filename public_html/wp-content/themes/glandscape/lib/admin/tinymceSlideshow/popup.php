...
<form name="gblu_slideshow" action="#">
...
foreach ($myterms as $term_list) {
	...
	?>
			...
			<fieldset>
						<legend>Slideshow size (Cycle and Nivo)</legend>
						<select id="slideshow_size" name="slideshow_size">
									
									<option value="fullwidth">Full width(900px)</option>
									<option value="normal">Normal(590px)</option>
