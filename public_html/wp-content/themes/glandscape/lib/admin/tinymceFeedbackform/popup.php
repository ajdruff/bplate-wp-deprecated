...
<script language="javascript" type="text/javascript" src="<?php echo get_template_directory_uri() ?>/lib/admin/tinymceFeedbackform/tinymce.js"></script>
<style type="text/css">
...
<form name="gblu_feedbackform" action="#">
			<fieldset>
			...
			<input type="submit" id="insert" name="insert" value="Insert shortcode" onClick="insertFeedbackformShortcode();" style="float:right; padding:10px; width:auto; height:auto;"/>
</form>
</body>
</html>
