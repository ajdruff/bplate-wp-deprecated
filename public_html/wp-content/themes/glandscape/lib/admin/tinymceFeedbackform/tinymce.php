<?php
class add_gblu_feedbackform {
	
	var $pluginname = 'gblu_feedbackform';
	var $path = '';
	var $internalVersion = 100;
	
	function add_gblu_feedbackform()  {
		
		// Set path to editor_plugin.js
		$this->path = get_template_directory_uri() . '/lib/admin/tinymceFeedbackform/';	
...
$tinymce_button = new add_gblu_feedbackform ();
