<?php
class add_gblu_video {
	
	var $pluginname = 'gblu_video';
	var $path = '';
	var $internalVersion = 100;
	
	function add_gblu_video()  {
		
		// Set path to editor_plugin.js
		$this->path = get_template_directory_uri() . '/lib/admin/tinymceVideo/';	
...
$tinymce_button = new add_gblu_video ();
