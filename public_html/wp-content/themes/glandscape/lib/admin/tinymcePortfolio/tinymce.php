<?php
class add_gblu_portfolio {
	
	var $pluginname = 'gblu_portfolio';
	var $path = '';
	var $internalVersion = 100;
	
	function add_gblu_portfolio()  {
		
		// Set path to editor_plugin.js
		$this->path = get_template_directory_uri() . '/lib/admin/tinymcePortfolio/';	
...
$tinymce_button = new add_gblu_portfolio ();
