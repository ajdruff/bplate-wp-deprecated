<?php
class add_gblu_contactform {
	
	var $pluginname = 'gblu_contactform';
	var $path = '';
	var $internalVersion = 100;
	
	function add_gblu_contactform()  {
		
		// Set path to editor_plugin.js
		$this->path = get_template_directory_uri() . '/lib/admin/tinymceContactform/';	
...
$tinymce_button = new add_gblu_contactform ();
