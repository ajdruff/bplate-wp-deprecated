<?php
class add_gblu_modules {
	
	var $pluginname = 'gblu_modules';
	var $path = '';
	var $internalVersion = 100;
	
	function add_gblu_modules()  {
		
		// Set path to editor_plugin.js
		$this->path = get_template_directory_uri() . '/lib/admin/tinymceModules/';	
...
$tinymce_button = new add_gblu_modules ();
