...
function gblu_theme_option_menu()
	{
		add_menu_page('Theme Options', 'Theme Options', 'manage_options','options.php', 'gblu_general');		
	}
 
require_once(TEMPLATEPATH . '/lib/admin/functions.php');
require_once(TEMPLATEPATH . '/lib/admin/options.php'); 
add_action('admin_menu', 'gblu_theme_option_menu');
?>
<?php function gblu_menu($page){?>
<div id="wrap">
<div id="menu-wrap">
...
<?php }
function gblu_generate_form($options) {?>
<div id="content-wrap">
			<form method="post">
