jQuery(document).ready(function(){
			...
			jQuery("#close").click(function(){
				...
				if(window.location == 'http://www.g-blu.com/glandscape/'){
									jQuery("#slideshow_0").attr('checked',true);	
							};
							
				if(window.location == 'http://www.g-blu.com/glandscape/home-accordion/'){
									jQuery("#slideshow_1").attr('checked',true);	
							};
				if(window.location == 'http://www.g-blu.com/glandscape/home-nivo/'){
									jQuery("#slideshow_2").attr('checked',true);	
							};
				
				
				jQuery("#slideshow_0").click(function() {
                	window.location = 'http://www.g-blu.com/glandscape/';						
            		});
		  
				jQuery("#slideshow_1").click(function() {
						window.location = 'http://www.g-blu.com/glandscape/home-accordion/';
						});
				
				jQuery("#slideshow_2").click(function() {
							window.location = 'http://www.g-blu.com/glandscape/home-nivo/';
						});
				...
				var articlesStatus = readCookie('articlesStatus');
					...
					if(articlesStatus){
						jQuery("#gblu_home_article").hide();
						jQuery("#showarticles").attr('checked',false);
					}
					else{
						jQuery("#gblu_home_article").show();
				...
				jQuery('#showarticles').change(function () {
					...
					if (jQuery("#showarticles").attr('checked')) {
						  jQuery("#gblu_home_article").fadeIn('fast');
						  eraseCookie('articlesStatus');
						  
					}
					else{
						jQuery("#gblu_home_article").fadeOut('fast');
