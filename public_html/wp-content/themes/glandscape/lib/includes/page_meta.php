<?php 
	...
	class pageMeta {
		...
		array(
				"name"			=> "slide_title",
				"title"			=> "Add a title",
				"description"	=> "title to go on slide",
				"type"			=> "text",
				"scope"			=>	array( "slide" ),
				"capability"	=> "edit_pages"
			),
			...
			array(
				...
				"description"	=> "subtitle to go on slide",
				"type"			=> "text",
				"scope"			=>	array( "slide" ),
				"capability"	=> "edit_pages"
			),
			...
			array(
				"name"			=> "slide_text",
				"title"			=> "add some text",
				"description"	=> "goes next to slide",
				"type"			=> "textarea",
				"scope"			=>	array( "slide" ),
				"capability"	=> "edit_pages"
			),
		...
		*/
		function createPageCustomFields() {
			if ( function_exists( 'add_meta_box' ) ) {
				...
				add_meta_box( 'page-custom-fields', 'Portfolio meta data', array( &$this, 'displayPageCustomFields' ), 'gbluportfolio', 'normal', 'high' );
				...
				foreach ( $this->pagemeta as $customField ) {
					...
					foreach ( $scope as $scopeItem ) {
						switch ( $scopeItem ) {
							...
							case "portfolio": {
								// Output on any post screen
								if ( basename( $_SERVER['SCRIPT_FILENAME'] )=="post-new.php?post_type=gbluportfolio" || $post->post_type=="gbluportfolio" )
									$output = true;
								break;
							}
