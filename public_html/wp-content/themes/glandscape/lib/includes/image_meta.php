	...
	class imageMeta {
		...
		var $imagemeta =	array(
			...
			array(
				...
				"type"			=> "radio",
				"radiovalue"	=> array( 
										"top" 		=> "Page top, for fullwidth template",
										"content" 	=> "Content area, for page with sidebar",
										// "side" 	=> "Side area with curved image",
		...
		*/
		function createImageCustomFields() {
			if ( function_exists( 'add_meta_box' ) ) {
				...
				add_meta_box( 'image-custom-fields', 'Images', array( &$this, 'displayImageCustomFields' ), 'gbluportfolio', 'side', 'default' );
