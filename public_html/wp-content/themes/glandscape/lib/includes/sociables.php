<?php
		...
		$smi_image_1=get_option('gblu_smi_image_1');
		$smi_url_1=get_option('gblu_smi_url_1');
		$smi_text_1=get_option('gblu_smi_text_1');

		$smi_image_2=get_option('gblu_smi_image_2');
		$smi_url_2=get_option('gblu_smi_url_2');
		$smi_text_2=get_option('gblu_smi_text_2');

		$smi_image_3=get_option('gblu_smi_image_3');
		$smi_url_3=get_option('gblu_smi_url_3');
		$smi_text_3=get_option('gblu_smi_text_3');
		
		$smi_image_4=get_option('gblu_smi_image_4');
		$smi_url_4=get_option('gblu_smi_url_4');
		$smi_text_4=get_option('gblu_smi_text_4');
		
		$smi_image_5=get_option('gblu_smi_image_5');
		$smi_url_5=get_option('gblu_smi_url_5');
		$smi_text_5=get_option('gblu_smi_text_5');
		
		$smi_image_6=get_option('gblu_smi_image_6');
		$smi_url_6=get_option('gblu_smi_url_6');
		$smi_text_6=get_option('gblu_smi_text_6');
		
		$smi_image_7=get_option('gblu_smi_image_7');
		$smi_url_7=get_option('gblu_smi_url_7');
		$smi_text_7=get_option('gblu_smi_text_7');
		
		$smi_image_8=get_option('gblu_smi_image_8');
		$smi_url_8=get_option('gblu_smi_url_8');
		$smi_text_8=get_option('gblu_smi_text_8');
		
		$smi_image_9=get_option('gblu_smi_image_9');
		$smi_url_9=get_option('gblu_smi_url_9');
		$smi_text_9=get_option('gblu_smi_text_9');
		
		$smi_image_10=get_option('gblu_smi_image_10');
		$smi_url_10=get_option('gblu_smi_url_10');
		$smi_text_10=get_option('gblu_smi_text_10');
